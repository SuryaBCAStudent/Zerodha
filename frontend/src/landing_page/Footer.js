  ...
  return (
    ...
    >
        ...
        <div className="row mt-5">
          <div className="col">
            <img
              ...
              style={{ width: "50%" }}
            />
            <p className="text-muted me-3">&copy; 2010 - 2026, Zerodha Broking Ltd. All rights reserved.</p>
          </div>
          <div className="col">
            <p>Account</p>
      ...
      <div className=" border-top mt-5 ">
        <ul className="d-flex flex-wrap gap-4 list-unstyled mt-3 justify-content-center">
          <li>
